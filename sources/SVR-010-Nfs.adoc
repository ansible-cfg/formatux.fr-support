...
Le paramètrage des partages de ressources s'effectue dans le fichier /etc/exports. A une ligne de ce fichier correspond un partage nfs.
...
* **/partage** : Chemin *absolu* du repertoire partagé ;
* **clients** : Machines autorisées à acceder aux ressources ;
