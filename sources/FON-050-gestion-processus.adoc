...
* **indexterm2:[synchrone]** : l'utilisateur perd l'accès au shell durant l'exécution de la commande. L'invite de commande réapparait à la fin de l'exécution du processus.
* **indexterm2:[asynchrone]** : le traitement du processus se fait en arrière-plan, l'invite de commande est réaffichée immédiatement.
...
=== Les commandes indexterm2:[fg] et indexterm2:[bg]
...
=== Les commandes indexterm2:[nice]/indexterm2:[renice]
