...
////
= FORMATUX - Support de cours GNU/Linux : Administration CentOS 6
:doctype: book
:toc!:
:docinfo:
:encoding: utf-8
...
:numbered:
:sectnumlevels: 2
:description: Support de cours Linux de Formatux - Administration
:revnumber: 1.0
:revdate: 17-04-2017
:revremark: Version 1 
:version-label!: 
...
include::FON-110-xargs.adoc[leveloffset=+1]
